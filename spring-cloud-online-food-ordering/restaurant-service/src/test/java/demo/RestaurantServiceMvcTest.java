...
public class RestaurantServiceMvcTest {
    ...
    public void testRoot() throws Exception {
        this.mockMvc.perform(get("/").accept(MediaType.parseMediaType(myParseType)))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.parseMediaType(myParseType)))
        .andExpect(content().string("Welcome to restaurant root!"));
    }
}
